...
var dropy = {
  ...
  eventHandler: function(){
    ...
    self.jQuerydropys.find('.dropy__content ul li a').click(function(){
      ...
      var jQuerytitle = jQuery(this).parents('.dropy').find('.dropy__title span');
    ...
    jQuery(document).bind('click', function(e){
        if (! jQuery(e.target).parents().hasClass('dropy')){ self.jQuerydropys.removeClass(self.openClass); }
    });
  }
};
